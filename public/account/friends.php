            ...
            <div class="friend-row friend-row--card">
                <div class="friend-row-main">
                    ...
                    <div class="friend-row-text">
                        <a href="<?= e(userProfileUrl((int) $p['id'])) ?>" class="friend-name-link"><strong><?php renderCosmeticPseudo(userDisplayName($p), $p['equipped_name'] ?? null); ?></strong></a>
        ...
        <div class="panel-body friends-list">
            ...
            <div class="friend-row friend-row--card">
                <div class="friend-row-main">
                    ...
                    <div class="friend-row-text">
                        <a href="<?= e(userProfileUrl((int) $f['id'])) ?>" class="friend-name-link"><strong><?php renderCosmeticPseudo(userDisplayName($f), $f['equipped_name'] ?? null); ?></strong></a>
            ...
            <?php if (!empty($sent)): ?>
                ...
                <div class="friend-row friend-row--card friend-row-muted">
                    <div class="friend-row-main">
                        ...
                        <div class="friend-row-text">
                            <strong><?php renderCosmeticPseudo(userDisplayName($s), $s['equipped_name'] ?? null); ?></strong>
